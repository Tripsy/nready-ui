 ...
 *
 * Its own module rather than a helper inside `api-docs.component.tsx`, because the catalogue
 * page is a server component and that file is `'use client'` — importing from it would pull
 * the whole docs renderer across the boundary for a coloured label.
 */
